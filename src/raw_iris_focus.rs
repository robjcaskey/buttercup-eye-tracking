...
// Keep the detector's existing public geometry entry points compatible.
#[allow(unused_imports)]
pub use crate::conic_solver::{
    CentralCameraLimbusProjectionEnvelope, LimbusProjectionAssessment,
    PROVISIONAL_CENTRAL_CAMERA_LIMBUS_ENVELOPE, assess_projected_circular_limbus_axes,
    projected_circular_limbus_axes_plausible,
};
...
// Compatibility for native-detector callers; temporal scale state is scene-owned.
pub use crate::eye_scene_model::limbus_scale::{
    FrontoParallelLimbusRadiusPrior, FrontoParallelLimbusRadiusPriorSource,
    FrontoParallelLimbusRadiusTracker, FrontoParallelLimbusScalePrediction,
};
#[cfg(test)]
use crate::eye_scene_model::limbus_scale::LIMBUS_LATEST_STRONG_CONTINUITY_HORIZON;
